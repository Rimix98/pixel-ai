    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-main)] p-4">
      <div className="relative w-full max-w-md rounded-3xl bg-[var(--bg-surface)]/50 border border-[var(--border)] p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-secondary)]">Ваш персональный AI-ассистент</p>
        </div>

        <h2 className="text-xl font-semibold text-center text-[var(--text-primary)] mb-6">Вход</h2>
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-secondary)]">
          Нет аккаунта?{" "}
          <a href="/register" className="text-[var(--accent)] font-medium hover:underline cursor-pointer">
            Регистрация
          </a>
        </p>
      </div>
